...
void solve()
{
    long long n,currentX,currentY,destinationX,destinationY;cin>>n>>currentX>>currentY>>destinationX>>destinationY;
    string s;cin>>s;
    for(long long i=0;i<n;i++)
    {
        ...
        if(s[i]=='W' and currentX>destinationX)currentX--;
        if(s[i]=='E' and currentX<destinationX)currentX++;
        if(s[i]=='N' and currentY<destinationY)currentY++;
        if(s[i]=='S' and currentY>destinationY)currentY--;
                if(currentX==destinationX and currentY==destinationY)
        {
            cout<<i+1<<endl;
            return;
